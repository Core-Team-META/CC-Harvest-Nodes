    ...
    ObjectBlock {
      ...
      Objects {
        ...
        UnregisteredParameters {
          ...
          Overrides {
            Name: "cs:InfoTextKey:tooltip"
            String: "The key for the text to display on this kiosk.  See _KioskText.lua for details!"
          }
        }
        Collidable_v2 {
