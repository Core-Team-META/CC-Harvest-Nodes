...
local Target_Starting_Position = Target:GetPosition()
...
function Reveal()
    Ease3D.EasePosition(Target, Target_Position, Duration*.5, Ease3D.EasingEquation.CUBIC, Ease3D.EasingDirection.INOUT)
    Ease3D.EaseRotation(Target, Target_Rotation, Duration*.5, Ease3D.EasingEquation.CUBIC, Ease3D.EasingDirection.INOUT)
    Ease3D.EaseScale(Target, Target_Scale, Duration*.5, Ease3D.EasingEquation.CUBIC, Ease3D.EasingDirection.INOUT)
    Task.Wait(Duration*.5)
    Ease3D.EasePosition(Target, Target_Starting_Position, Duration*.5, Ease3D.EasingEquation.BOUNCE, Ease3D.EasingDirection.OUT)
    Task.Wait(Duration*.5)
end
